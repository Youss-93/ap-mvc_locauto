    ...
    public function modifier() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            try {
                ...
                if (isset($_FILES['image_loc']) && $_FILES['image_loc']['error'] === UPLOAD_ERR_OK) {
                    $uploaded_image = $this->uploadImage($_FILES['image_loc']);
                    if ($uploaded_image) {
    ...
    public function ajouter() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            try {
                ...
                $toutesCategories = $this->categorieModel->getAll();
