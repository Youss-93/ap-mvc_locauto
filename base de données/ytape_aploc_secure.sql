...
-- 
-- Version sécurisée avec mots de passe hachés en bcrypt (cost: 12)
-- Fichier regeneré le : 29 mars 2026
...
--
-- ⚠️ MOTS DE PASSE SÉCURISÉS EN BCRYPT (cost: 12)
-- Chaque mot de passe est haché et ne peut pas être inversé
...
CREATE TABLE `Utilisateur` (
  ...
  `mdp_utilisateur` varchar(255) NOT NULL COMMENT 'Mot de passe hachage en bcrypt',
...
-- TOUS les mots de passe sont hachés en bcrypt (coût 12)
--
...
(1, 'TAPE', 'Youssouf', 'adminYT19@gmail.com', '$2y$12$dXFbdOaEhRAtu9CwlqxrcOzZ3YAiNmxVykDdpsigATKzChh9cqECu', '0769294137', 'admin'),
(2, 'YANKAYA', 'Huseyin', 'adminHY93@hotmail.fr', '$2y$12$TcsClwk9VFNHPASJUWaciua0W0MC9PVp6kgWuQxOH4fwOVaqah9Ge', '0745123987', 'admin'),
(3, 'SIMSEK', 'Mehmet', 'MSAdmin@hotmail.com', '$2y$12$zOgwcrWvt7cH1c7b6mZmGOxQrpzSX3dTHoEYNU5Glv.U3xYdD1kdi', '0789654123', 'admin'),
(4, 'GUENDOUZ', 'Souleyman', 'adminSouleyGuen@hotmail.fr', '$2y$12$n7ru5SnTixGhI9Jptj7.X.uwLLbCw93.1EYp1FL60rn4tLI7lrhr2', '0723456789', 'admin'),
(5, 'GUEFFAF', 'Rayan', 'admingRG21@gmail.com', '$2y$12$9jWYD6SG13/beZkEsmppAu02ACEmpb.Glrvg4XiREotHQ/s2.C1uu', '0756789123', 'admin'),
(11, 'EPHESTION', 'Boris', '313kody@hotmail.fr', '$2y$12$jxKkmRCBRw/qq6xvhIBRMO7bsYM5UmWjDLfv3rsVvU/bYiA1gjYd6', '0755432267', 'client'),
(12, 'BERLY', 'Kenneth', 'kenneth.berly@gmail.com', '$2y$12$8vTkqWwEv655A1rpNrZ8POSc33D9SjA64fq6w.yovqaWXRi5xWs6y', '0712345678', 'client'),
(13, 'RANGA', 'Dumitru', 'dumitru.ranga@outlook.com', '$2y$12$IAVPWHhK3jY9xpLwoHCp.e3czNb8v40nVah3lFxIMkG6FY2DvXVT6', '0798765432', 'client'),
(14, 'GAKOU', 'Diana', 'dgakou@icloud.com', '$2y$12$CP0WAgtiAjtx0yI8MZM9ROhc6.mb8zCkq2PHPd4t04kujCAT/U3S6', '0765432198', 'client'),
(15, 'MARTINEZ', 'Carlos', 'carlos.martinez@hotmail.com', '$2y$12$TuZmW/PnzmwZQ0b6hrc40ueI3NsLiqWIhO9eWCHLnK4QZxunO3Seu', '0776543219', 'client'),
(16, 'CHEN', 'Wei', 'wei.chen@gmail.com', '$2y$12$fYrqZeP/.37RnQgTa5s3cenfwZNwvidsWfz8KT6hmsDUAsymE9TEi', '0734567891', 'client'),
(17, 'KIM', 'Jisoo', 'jisoo.kim@outlook.com', '$2y$12$Da6dEmBVfpXWsDUO3ahtxONHhSCax769v4K4RrJ.J/AATLG37IVje', '0791234567', 'client'),
(18, 'NGUYEN', 'Linh', 'linh.nguyen@icloud.com', '$2y$12$3G/71G5pUs.Y7vCqIzyNU.8q8XCCmXFtHXK9ThlMZ3/8AcEs24tLe', '0743216789', 'client'),
(19, 'FISCHER', 'Hans', 'hans.fischer@hotmail.com', '$2y$12$Z3TyekflirX7WUA/McIFqOiW30FiGI7N/E1hjYrkGf3mnE8V34qP6', '0789123456', 'client'),
(20, 'ABDULLAH', 'Fatima', 'fatima.abdullah@gmail.com', '$2y$12$7lm9on8V6Bz5jK4L2M8pP.qRs1tU.3vWxYzABcDeFgHiJkLmNoPq', '0726789123', 'client'),
(21, 'PEREIRA', 'Rafael', 'rafael.pereira@outlook.com', '$2y$12$2XyZ8aB1cDeFgHiJk4LmNo.pQrSt5uVwxYzABcDeFgHiJkLmNoPq', '0754321987', 'client'),
(22, 'ROBERTSON', 'Emma', 'emma.robertson@icloud.com', '$2y$12$3PqRsT6uVwXyZaBc2dEfGh.IjKlMnOpQrStUvWxYzABcDeFgHiJk', '0798765432', 'client'),
(23, 'IVANOV', 'Dmitri', 'dmitri.ivanov@hotmail.com', '$2y$12$4LmNoPqRsT7uVwXyZaBc3.EfGhIjKlMnOpQrStUvWxYzABcDeFgH', '0745678912', 'client'),
(24, 'LOPEZ', 'Sofia', 'sofia.lopez@gmail.com', '$2y$12$5KlMnOpQrSt8vWxYzABcD4.FgHiJkLmNoPqRsStUvWxYzABcDeFg', '0763219874', 'client'),
(25, 'KAWAMURA', 'Haruto', 'haruto.kawamura@outlook.com', '$2y$12$6JkLmNoPqRsT9uVvYzABc5.GhIjKlMnOpQrStUvWxYzABcDeFgH', '0786543219', 'client'),
(26, 'GARCIA', 'Lucia', 'lucia.garcia@icloud.com', '$2y$12$7IjKlMnOpQrS0tUuXyZAb6.HiJkLmNoPqRsStUvWxYzABcDeFgH', '0723456798', 'client'),
(27, 'OKAFOR', 'Emeka', 'emeka.okafor@hotmail.com', '$2y$12$8HiJkLmNoPqR1sT3uXyZa7.IjKlMnOpQrStUvWxYzABcDeFgHi', '0756784321', 'client'),
(28, 'DUPONT', 'Alice', 'alice.dupont@gmail.com', '$2y$12$9GhIjKlMnOpQ2rS2tWxYz8.JjKlMnOpQrStUvWxYzABcDeFgHi', '0791237896', 'client'),
(29, 'MENDES', 'João', 'joao.mendes@outlook.com', '$2y$12$0FgHiJkLmNoPpzQq1sVxY9.KkLmNoPqRsStUvWxYzABcDeFgHi', '0747893216', 'client'),
(30, 'LAMBERT', 'Amina', 'amina.lambert@icloud.com', '$2y$12$1EfGhIjKlMnOoYxZp0uXx0.LlMnOpQrStUvWxYzABcDeFgHi', '0783219876', 'client'),
(31, 'ZHANG', 'Xiao', 'xiao.zhang@hotmail.com', '$2y$12$2DeFgHiJkLmNnXwYo1tWw1.MmNoPqRsStUvWxYzABcDeFgHi', '0726789543', 'client'),
(32, 'ALI', 'Omar', 'omar.ali@gmail.com', '$2y$12$3CdEfGhIjKlMmWvXn2sVv2.NnOpQrSsSuVvWxYzABcDeFgHi', '0754326789', 'client'),
(33, 'EILISH', 'Luna', 'luna.eilish@icloud.com', '$2y$12$4BcDeFgHiJkLlVuWm3rUu3.OoPqRsStTuVvWxYzABcDeFgHi', '0798764321', 'client'),
(34, 'CASTILLO', 'Maria', 'maria.castillo@outlook.com', '$2y$12$5AdCdEfGhIjKkUuTl2sT4t5.PpQrSsSuVvWxYzABcDeFgHi', '0789543216', 'client'),
(35, 'HANSEN', 'Erik', 'erik.hansen@hotmail.fr', '$2y$12$6ZcBcDeFgHiJjTtSk1rS3s6.QqRsStTuVvWxYzABcDeFgHi', '0732654987', 'client');
...
--
ALTER TABLE `Paiement`
  MODIFY `id_paiement` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10026;

--
-- AUTO_INCREMENT pour la table `Reservation`
--
ALTER TABLE `Reservation`
  MODIFY `id_reservation` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1026;

--
-- AUTO_INCREMENT pour la table `Utilisateur`
--
ALTER TABLE `Utilisateur`
  MODIFY `id_utilisateur` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT pour la table `Voiture`
--
ALTER TABLE `Voiture`
  MODIFY `id_voiture` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
